...
<div class="content" align="center">
	<h1>Here is the effect of the new GTM container for a multi-domain client</h1><br>
...
?> 
  ...
  <div><p>This is the whitelisted phone number: <img src="http://bendplatform.com/G5/phone.png" alt="Whitelisted phone number"/></p></div>
	<div><p>This is the flipped phone number: 5416398518</p></div>
  <div><p>This is an internal link to confirm that flipped phone number remains: <a href="http://bendplatform.com/G5/multi/multiclone.php" target="_blank">Clone page</a></p></div>
...
<div>
  <h2>Add new container code here and submit<br>to update the container used on this page</h2>
  <form action="http://bendplatform.com/G5/multi/multirefresh.php" method="post" enctype="multipart/form-data">
...
<iframe src="http://bendplatform.com/G5/multi/multiiframe.php" width="456" height="200"></iframe>
<br>
<br>
</div>
</div>
