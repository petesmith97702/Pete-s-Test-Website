...
<div class="content" align="center">
	<h1>The link updated according to plan</h1><br>
<?php
...
$c = mysqli_real_escape_string($conn, $_REQUEST["post_preview"]);
$sql = "UPDATE `preview` SET `linkurl`='$c' WHERE key_id=1";
...
header('Location: http://bendplatform.com/G5/');
?>
