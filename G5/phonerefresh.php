...
$c = mysqli_real_escape_string($conn, $_REQUEST["post_gtm"]);
$sql = "UPDATE `phonegtm` SET current='$c' WHERE key_id=1";
...
header('Location: http://bendplatform.com/G5/phonenumbers.php');
?>
